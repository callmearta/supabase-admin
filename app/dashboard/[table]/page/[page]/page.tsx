...
import { getPagination } from "@/utils/supabase/get-pagination";
...
export default async function Page({
    ...
    const { table, page } = await params;
    const supabase = await createClient();
    const { from, to } = getPagination(+page, SUPABASE_ADMIN_CONFIG.general.itemsPerPage || 50);
